 ...
 */
    ...
    typedef struct NVPW_Device_RawMetricsConfig_Create_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } NVPW_Device_RawMetricsConfig_Create_Params;
#define NVPW_Device_RawMetricsConfig_Create_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_Device_RawMetricsConfig_Create_Params, pRawMetricsConfig)
    ...
    typedef struct NVPW_Device_MetricsEvaluator_CalculateScratchBufferSize_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } NVPW_Device_MetricsEvaluator_CalculateScratchBufferSize_Params;
#define NVPW_Device_MetricsEvaluator_CalculateScratchBufferSize_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_Device_MetricsEvaluator_CalculateScratchBufferSize_Params, scratchBufferSize)
    ...
    typedef struct NVPW_Device_MetricsEvaluator_Initialize_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        /// by 'NVPW_Device_MetricsEvaluator_CalculateScratchBufferSize'
        size_t scratchBufferSize;
    ...
    } NVPW_Device_MetricsEvaluator_Initialize_Params;
#define NVPW_Device_MetricsEvaluator_Initialize_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_Device_MetricsEvaluator_Initialize_Params, pMetricsEvaluator)
