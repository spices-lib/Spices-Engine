...
#define NVPW_VK_Profiler_IsGpuSupported_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_Profiler_IsGpuSupported_Params, wslSupportLevel)
 ...
 */
    ...
    /// This is associated with one VKDevice
    typedef struct NVPW_VK_MiniTrace_DeviceState NVPW_VK_MiniTrace_DeviceState;

    typedef struct NVPW_VK_MiniTrace_IsGpuSupported_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        /// [out]
        NVPW_WslSupportLevel wslSupportLevel;
    } NVPW_VK_MiniTrace_IsGpuSupported_Params;
#define NVPW_VK_MiniTrace_IsGpuSupported_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_IsGpuSupported_Params, wslSupportLevel)

    /// 'NVPW_VK_LoadDriver' must be called prior to this API
    NVPA_Status NVPW_VK_MiniTrace_IsGpuSupported(NVPW_VK_MiniTrace_IsGpuSupported_Params* pParams);

    typedef struct NVPW_VK_MiniTrace_DeviceState_Create_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        void* pfnGetDeviceProcAddr;
        /// [out]
        struct NVPW_VK_MiniTrace_DeviceState* pDeviceState;
    } NVPW_VK_MiniTrace_DeviceState_Create_Params;
#define NVPW_VK_MiniTrace_DeviceState_Create_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_DeviceState_Create_Params, pDeviceState)

    /// 'NVPW_VK_LoadDriver' must be called prior to this API
    NVPA_Status NVPW_VK_MiniTrace_DeviceState_Create(NVPW_VK_MiniTrace_DeviceState_Create_Params* pParams);

    typedef struct NVPW_VK_MiniTrace_DeviceState_Destroy_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        /// [in]
        struct NVPW_VK_MiniTrace_DeviceState* pDeviceState;
    } NVPW_VK_MiniTrace_DeviceState_Destroy_Params;
#define NVPW_VK_MiniTrace_DeviceState_Destroy_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_DeviceState_Destroy_Params, pDeviceState)
    ...
    typedef struct NVPW_VK_MiniTrace_Queue_Register_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        /// [in]
        VkQueue queue;
    } NVPW_VK_MiniTrace_Queue_Register_Params;
#define NVPW_VK_MiniTrace_Queue_Register_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_Queue_Register_Params, queue)

    NVPA_Status NVPW_VK_MiniTrace_Queue_Register(NVPW_VK_MiniTrace_Queue_Register_Params* pParams);

    typedef struct NVPW_VK_MiniTrace_Queue_Unregister_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        /// [in]
        VkQueue queue;
    } NVPW_VK_MiniTrace_Queue_Unregister_Params;
#define NVPW_VK_MiniTrace_Queue_Unregister_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_Queue_Unregister_Params, queue)

    NVPA_Status NVPW_VK_MiniTrace_Queue_Unregister(NVPW_VK_MiniTrace_Queue_Unregister_Params* pParams);


    typedef NVPA_Bool (*NVPW_VK_MiniTrace_PredicateFuncInvoker)(void* pPredicateFunc, VkQueue queue);


    typedef struct NVPW_VK_MiniTrace_CommandBuffer_FrontEndTrigger_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        NVPW_VK_MiniTrace_PredicateFuncInvoker predicateFuncInvoker;
    ...
    } NVPW_VK_MiniTrace_CommandBuffer_FrontEndTrigger_Params;
#define NVPW_VK_MiniTrace_CommandBuffer_FrontEndTrigger_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_CommandBuffer_FrontEndTrigger_Params, predicateFuncSize)
    ...
    typedef void (*NVPW_VK_MiniTrace_MarkerFuncInvoker)(void* pMarkerFunc, VkQueue queue, uint8_t* pUserData, size_t userDataSize);


    typedef struct NVPW_VK_MiniTrace_CommandBuffer_MarkerCpu_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        VkCommandBuffer commandBuffer;
        /// [in] will be invoked at command list submit-time
        NVPW_VK_MiniTrace_MarkerFuncInvoker markerFuncInvoker;
        /// [in] If not 0, a copy of the MarkerFunc buffer will be stored in the command buffer
        const void* pMarkerFunc;
        /// [in]
        size_t markerFuncSize;
        /// [in] If not 0, a copy of the UserData buffer will be stored in the command buffer; this requires
        /// `pMarkerFunc` to not be 0 too
        const uint8_t* pUserData;
        /// [in]
        size_t userDataSize;
    } NVPW_VK_MiniTrace_CommandBuffer_MarkerCpu_Params;
#define NVPW_VK_MiniTrace_CommandBuffer_MarkerCpu_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_CommandBuffer_MarkerCpu_Params, userDataSize)
    ...
    typedef uint64_t (*NVPW_VK_MiniTrace_AddressFuncInvoker)(void* pAddressFunc, VkQueue queue);


    typedef struct NVPW_VK_MiniTrace_CommandBuffer_HostTimestamp_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        uint32_t payload;
        /// [in] will be invoked at command list submit-time
        NVPW_VK_MiniTrace_AddressFuncInvoker addressFuncInvoker;
        /// [in]  if not 0, a copy of AddressFunc buffer will be stored in the command list
        const void* pAddressFunc;
        /// [in]
        size_t addressFuncSize;
    } NVPW_VK_MiniTrace_CommandBuffer_HostTimestamp_Params;
#define NVPW_VK_MiniTrace_CommandBuffer_HostTimestamp_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_CommandBuffer_HostTimestamp_Params, addressFuncSize)
