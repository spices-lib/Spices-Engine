...
namespace Spiecs {
	...
	void VulkanImage::GenerateMipmaps(VkFormat imageFormat, int32_t texWidth, int32_t texHeight)
	{
		...
		*/
		...
		{
			SPIECS_CORE_ERROR("texture image format does not support linear blitting!");
		}
	...
	void VulkanImage::CreateImageView(VkFormat format, VkImageViewType viewType, VkImageAspectFlags aspectFlags)
	{
		...
		*/
		...
		VulkanDebugUtils::SetObjectName(VK_OBJECT_TYPE_IMAGE_VIEW, m_ImageView, m_VulkanState.m_Device, "ImageView");
	}
