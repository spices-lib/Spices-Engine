	...
	public:
		...
		*/
		BasePassRenderer(
			...
			: Renderer(rendererName, vulkanState, descriptorPool, device, rendererResourcePool, cmdThreadPool, RenderPassStatistics::Timestamp | RenderPassStatistics::Pipeline, true, true)
		{}
