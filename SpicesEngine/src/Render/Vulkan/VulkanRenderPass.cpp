...
namespace Spices {
		...
		, m_VulkanDevice(vulkanDevice)
	{
		...
		*/
		...
		DEBUGUTILS_SETOBJECTNAME(VK_OBJECT_TYPE_RENDER_PASS, reinterpret_cast<uint64_t>(m_RenderPass), m_VulkanState.m_Device, passName)
		...
		for (size_t i = 0; i < MaxFrameInFlight; i++)
		{
			...
			*/
			...
			DEBUGUTILS_SETOBJECTNAME(VK_OBJECT_TYPE_FRAMEBUFFER, reinterpret_cast<uint64_t>(m_SwapChainFramebuffers[i]), m_VulkanState.m_Device, passName)
		}
	}
