#ifndef NVPERF_VULKANSC_HOST_H
#define NVPERF_VULKANSC_HOST_H
...
/**
 *  @file   nvperf_vulkansc_host.h
 */

    typedef struct NVPW_VKSC_RawMetricsConfig_Create_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } NVPW_VKSC_RawMetricsConfig_Create_Params;
#define NVPW_VKSC_RawMetricsConfig_Create_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VKSC_RawMetricsConfig_Create_Params, pRawMetricsConfig)
    ...
    typedef struct NVPW_VKSC_MetricsEvaluator_CalculateScratchBufferSize_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } NVPW_VKSC_MetricsEvaluator_CalculateScratchBufferSize_Params;
#define NVPW_VKSC_MetricsEvaluator_CalculateScratchBufferSize_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VKSC_MetricsEvaluator_CalculateScratchBufferSize_Params, scratchBufferSize)
    ...
    typedef struct NVPW_VKSC_MetricsEvaluator_Initialize_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } NVPW_VKSC_MetricsEvaluator_Initialize_Params;
#define NVPW_VKSC_MetricsEvaluator_Initialize_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VKSC_MetricsEvaluator_Initialize_Params, pMetricsEvaluator)
