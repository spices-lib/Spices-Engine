...
namespace SpicesTest {
	...
	*/
	TEST_F(MemoryPool_test, StressTesting) {
		...
		constexpr int nCounts_0  = 1 * 1000000 * 5;    // 1G
		constexpr int nCounts_1  = 1 * 4000    * 5;    // 1G
		constexpr int nCounts_2  = 1 * 1000    * 5;    // 1G
		constexpr int nCounts_3  = 1 * 128     * 5;    // 1G
		...
		for (int i = 0; i < nThreads; i++)
		{
			std::thread t([&]() {
				...
				for(;;)
				{
					void** objects = new void*[nCounts_0 + nCounts_1 + nCounts_2 + nCounts_3];
