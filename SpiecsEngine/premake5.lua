...
project "SpiecsEngine"
	...
	defines
	{
		...
		'SPIECS_lOGFILE_PATH=std::string("%{wks.location}/bin/Log/")',

		-- Define Engine Extent Processes Folder.
		'SPIECS_EXTENT_PROCESS_PATH=std::string("%{wks.location}/vendor/")',
